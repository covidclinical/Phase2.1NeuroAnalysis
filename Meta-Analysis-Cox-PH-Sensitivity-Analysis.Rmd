...
We also perform additional meta-analyses in order to evaluate the estimates of the indiviudal covariates (e.g., age, comoridities, etc) on each outcome.
