...
This notebook organizes each participating healthcare system's data to abstract the date up to which patient's were admitted. Additionally, we generate a table of each site's adult, pediatric, and total patient counts.
